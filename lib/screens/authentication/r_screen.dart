      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Back button and "Register Account" in a row
              Row(
              ...
              Text("WhatsApp Number", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 15, color: textColor)),
              ...
              // PASSWORD FIELD
              Text("Password", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 15, color: textColor)),
              const SizedBox(height: 6),
              TextField(
                controller: _passC,
                obscureText: hidePassword,
                style: GoogleFonts.poppins(color: textColor),
                decoration: _inputDecoration("Minimum 6 characters", fieldBgColor, hintColor).copyWith(
                  suffixIcon: IconButton(
                    icon: Icon(hidePassword ? Icons.visibility_off : Icons.visibility, color: Colors.deepOrange),
